...
class SpecialDpsComplete extends Model
{
  use HasFactory;
  use LogsActivity;
  ...
  protected static function boot()
  {
    ...
    /*static::updated(function ($dpsComplete) {
      ...
      $transaction = Transaction::where('transactionable_id', $dpsComplete->id)
        ->where('transactionable_type', SpecialDpsComplete::class)
        ->first();
  ...
  public function getDescriptionForEvent(string $eventName): string
  {
    ...
    switch ($eventName) {
      case 'created':
        $description = "বিশেষ সঞ্চয় (Special) উত্তোলন নতুন এন্ট্রি করা হয়েছে";
        break;
      case 'updated':
        $description = "বিশেষ সঞ্চয় (Special) উত্তোলন এন্ট্রি আপডেট করা হয়েছে";
        break;
      case 'deleted':
        $description = "বিশেষ সঞ্চয় (Special) উত্তোলন থেকে এন্ট্রি ডিলেট করা হয়েছে";
        break;
      default:
        $description = "বিশেষ সঞ্চয় (Special) উত্তোলন {$eventName}";
    }
