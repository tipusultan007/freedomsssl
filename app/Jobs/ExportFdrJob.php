...
class ExportFdrJob implements ShouldQueue
{
  ...
  public function handle(): void
  {
    ...
    $filename = 'স্থায়ী_সঞ্চয়_তালিকা_রিপোর্ট_' . now()->format('d-m-Y_H-i-s') . '.csv';
    ...
    try {
      ...
      Fdr::with('user')->chunk($chunkSize, function ($dailySavings) use ($csv, $columnOrder) {
