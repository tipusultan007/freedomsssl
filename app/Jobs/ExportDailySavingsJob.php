...
class ExportDailySavingsJob implements ShouldQueue
{
  ...
  public function handle(): void
  {
    ...
    $filename = 'দৈনিক_সঞ্চয়_তালিকা_রিপোর্ট' . now()->format('d-m-Y_H-i-s') . '.csv';
    ...
    try {
      ...
      DailySavings::with('user')->chunk($chunkSize, function ($dailySavings) use ($csv, $columnOrder) {
