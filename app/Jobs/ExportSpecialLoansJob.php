...
class ExportSpecialLoansJob implements ShouldQueue
{
  ...
  public function handle(): void
  {
    ...
    $filename = 'মাসিক_ঋণ_তালিকা_রিপোর্ট_' . now()->format('d-m-Y_H-i-s') . '.csv';
    ...
    try {
      ...
      SpecialDpsLoan::with('user')->chunk($chunkSize, function ($dailySavings) use ($csv, $columnOrder) {
