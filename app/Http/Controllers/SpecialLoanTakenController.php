...
class SpecialLoanTakenController extends Controller
{
    ...
    public function show(Request $request, SpecialLoanTaken $specialLoanTaken)
    {
        ...
        return view(
            'app.special_loan_takens.show',
            compact('specialLoanTaken')
        );
    }
    ...
    public function edit(Request $request, SpecialLoanTaken $specialLoanTaken)
    {
        ...
        return view(
            ...
            compact('specialLoanTaken', 'users', 'specialDpsLoans', 'users')
        );
    }
    ...
    )
    {
        ...
        return redirect()
            ->route('special-loan-takens.index')
    ...
    public function dataTakenLoanTransaction(Request $request)
    {
        ...
        $totalData      = SpecialInstallment::leftJoin('special_loan_interests', 'special_loan_interests.dps_installment_id', '=', 'special_installments.id')
