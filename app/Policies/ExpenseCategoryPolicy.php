...
class ExpenseCategoryPolicy
{
    ...
    {
        return $user->hasPermissionTo('list expensecategories');
    }
    ...
    {
        return $user->hasPermissionTo('view expensecategories');
    }
    ...
    {
        return $user->hasPermissionTo('create expensecategories');
    }
    ...
    {
        return $user->hasPermissionTo('update expensecategories');
    }
    ...
    {
        return $user->hasPermissionTo('delete expensecategories');
    }
