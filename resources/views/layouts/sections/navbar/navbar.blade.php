                  ...
                  <div class="dropdown-shortcuts-list scrollable-container">
                    ...
                    <span class="dropdown-shortcuts-icon rounded-circle mb-2">
                      <i class="ti ti-calendar fs-4"></i>
                        ...
                        <a href="{{url('daily-collections')}}" class="stretched-link fw-bolder text-success">দৈনিক</a>
                        <small class="text-muted mb-0">সঞ্চয়/ঋণ আদায়</small>
                      </div>
                      <div class="dropdown-shortcuts-item col">
                    <span class="dropdown-shortcuts-icon rounded-circle mb-2">
                      <i class="ti ti-file-invoice fs-4"></i>
                    </span>
                        <a href="{{url('dps-installments')}}" class="stretched-link fw-bolder text-danger">মাসিক (DPS)</a>
                        <small class="text-muted mb-0">সঞ্চয়/ঋণ আদায়</small>
                      </div>
                    </div>
                    <div class="row row-bordered overflow-visible g-0">
                    ...
                    <span class="dropdown-shortcuts-icon rounded-circle mb-2">
                      <i class="ti ti-users fs-4"></i>
                        ...
                        <a href="{{url('special-installments')}}" class="stretched-link fw-bolder text-info">বিশেষ (Special)</a>
                        <small class="text-muted mb-0">সঞ্চয়/ঋণ আদায়</small>
                      </div>
                      <div class="dropdown-shortcuts-item col">
                    <span class="dropdown-shortcuts-icon rounded-circle mb-2">
                      <i class="ti ti-lock fs-4"></i>
                        ...
                        <a href="{{url('profit-collections')}}" class="stretched-link fw-bolder text-primary">স্থায়ী সঞ্চয়</a>
                        <small class="text-muted mb-0">মুনাফা উত্তোলন</small>
                      </div>
                    </div>
                    {{--<div class="row row-bordered overflow-visible g-0">
                      <div class="dropdown-shortcuts-item col">
              ...
              <li class="nav-item navbar-dropdown dropdown-user dropdown">
                <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                  <div class="avatar avatar-online">
                    <img src="{{ asset('storage/images/profile/user.png') }}"
                    ...
                    <a class="dropdown-item"
                      ...
                      <div class="d-flex">
                        <div class="flex-shrink-0 me-3">
                          <div class="avatar avatar-online">
                            <img
                              src="{{ asset('storage/images/profile/user.png') }}"
                              alt class="h-auto rounded-circle">
                          </div>
                        </div>
