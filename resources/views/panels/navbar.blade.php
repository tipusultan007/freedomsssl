...
<div class="navbar-container d-flex content">
  <div class="bookmark-wrapper d-flex align-items-center">
    ...
    <ul class="nav navbar-nav bookmark-icons">
      <li class="nav-item d-none d-lg-block"><a class="nav-link" href="{{ url('daily-collections') }}"
          data-bs-toggle="tooltip" data-bs-placement="bottom" title="Daily Collections">Daily Collection</a></li>
      <li class="nav-item d-none d-lg-block"><a class="nav-link" href="{{ url('dps-installments') }}"
          data-bs-toggle="tooltip" data-bs-placement="bottom" title="DPS Installments">DPS</a></li>
      <li class="nav-item d-none d-lg-block"><a class="nav-link" href="{{ url('special-installments') }}"
          data-bs-toggle="tooltip" data-bs-placement="bottom" title="Special Installments">Special DPS</a></li>
      <li class="nav-item d-none d-lg-block"><a class="nav-link" href="{{ url('profit-collections') }}"
          data-bs-toggle="tooltip" data-bs-placement="bottom" title="Profit Withdraw">FDR Profit</a></li>
    </ul>
