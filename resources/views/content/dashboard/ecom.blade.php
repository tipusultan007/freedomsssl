      ...
      <div class="d-flex align-items-end row">
        <div class="col-7">
          <div class="card-body text-nowrap">
            @php
$cashData = getDailyTransactionByManager(auth()->id(), date('Y-m-d'));
 @endphp
            <h5 class="card-title mb-0">{{ getBengaliGreeting() }} <span class="text-warning">{{ auth()->user()->name }}!</span> 🎉</h5>
            <p class="mb-2">আজকে আপনার লেনদেন</p>
            <h4 class="text-primary mb-1 me-3"><span class="text-success">{{ $cashData['cashin'] }}</span> <span class="text-danger">{{ $cashData['cashout'] }}</span></h4>
            <a href="{{ route('manager.transactions') }}" class="btn btn-primary">লেনদেন দেখুন</a>
          </div>
        </div>
    ...
    <div class="card h-100">
      <div class="card-header">
        <div class="d-flex justify-content-between mb-3">
          <h5 class="card-title mb-0 fw-bolder">পরিসংখ্যান</h5>
        ...
        <div class="row gy-3">
          <div class="col-md-3 col-6">
            <div class="d-flex align-items-center">
              ...
              <div class="card-info">
                <h5 class="mb-0">{{ number_format($dashboard['total_customers'],0) }}</h5>
                <small>সদস্য</small>
              </div>
            </div>
          </div>
          <div class="col-md-3 col-6">
            <div class="d-flex align-items-center">
              ...
              <div class="card-info">
                <h5 class="mb-0">{{ number_format($dashboard['total_loans'],0) }}</h5>
          ...
          <div class="col-md-3 col-6">
            <div class="d-flex align-items-center">
              ...
              <div class="card-info">
                <h5 class="mb-0">{{ number_format($dashboard['total_loans_return'],0) }}</h5>
                <small>ঋণ আদায়</small>
              </div>
            </div>
          </div>
          <div class="col-md-3 col-6">
            <div class="d-flex align-items-center">
              ...
              <div class="card-info">
                <h5 class="mb-0">{{ number_format($dashboard['total_loans_interest'],0) }}</h5>
                <small>লভ্যাংশ আদায়</small>
              </div>
            </div>
          </div>
        </div>
