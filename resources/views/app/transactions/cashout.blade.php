...
@section('content')
  <div class="container-fluid">
    <h4 class="text-danger text-center fw-bolder">নগদ প্রদান</h4>
    <hr>
    <form id="filter-form">
      <div class="row">
        <div class="col-md-3">
        ...
        <div class="col-md-3">
          ...
          <select id="transactionable-type-filter" name="transactionable_type_filter" class="form-control select2">
            ...
            <option value="App\Models\SavingsCollection">দৈনিক সঞ্চয় উত্তোলন</option>
            <option value="App\Models\DailyLoan">দৈনিক ঋন প্রদান</option>
            ...
            <option value="App\Models\FdrComplete">স্থায়ী সঞ্চয় (FDR) উত্তোলন (নিস্পত্তি)</option>
