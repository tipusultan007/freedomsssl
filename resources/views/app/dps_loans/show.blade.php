                        ...
                        <div class="info-container">
                            <ul class="list-unstyled">
                                ...
                                <li class="mb-75">
                                    ...
                                    <span >{{ $dpsLoan->dueInterest }}</span>
                                </li>
                                <li class="mb-75">
                                    <span class="fw-bolder me-25">Grace:</span>
                                    <span>{{ $dpsLoan->grace }}</span>
                                </li>

                                <li class="mb-75">
                                    <span class="fw-bolder me-25">status:</span>
                                    <span class="badge bg-light-success">{{ strtoupper($dpsLoan->status)??'' }}</span>
                                </li>
