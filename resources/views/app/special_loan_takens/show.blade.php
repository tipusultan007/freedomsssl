            ...
            <div class="col-xl-3 col-lg-4 col-md-4 order-1 order-md-0">
                        ...
                        <div class="user-avatar-section">
                            <div class="d-flex align-items-center flex-column">
                                <img
                                    ...
                                    src="{{ $specialLoanTaken->user->profile_photo_url??'' }}"
                                    height="110"
                                    width="110"
                                    alt="User avatar"
                                />
              ...
              <span class="badge bg-light-primary p-75 rounded">
                <i data-feather="dollar-sign" class="font-medium-2"></i>
                                ...
                                <div class="ms-75">
                                    <h4 class="mb-0">{{ $specialLoanTaken->remain }}</h4>
                                    <small>Loan</small>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="info-container">
                            <ul class="list-unstyled">
                                <li class="mb-75">
                                    ...
                                    <span>{{ $specialLoanTaken->account_no??'' }}</span>
                                </li>
                                <li class="mb-75">
                                    <span class="fw-bolder me-25">Loan Amount:</span>
                                    <span>{{ $specialLoanTaken->loan_amount??'' }}</span>
                                </li>
                                <li class="mb-75">
                                    <span class="fw-bolder me-25">Interest:</span>
                                    <span>{{ $specialLoanTaken->interest1??'' }}% {{ $specialLoanTaken->interest2>0?' | '.$specialLoanTaken->interest2.'%':'' }}</span>
                                </li>
                                <li class="mb-75">
                                    <span class="fw-bolder me-25">Upto Amount:</span>
                                    <span>{{ $specialLoanTaken->upto_amount??'N/A' }}</span>
                                </li>
                                <li class="mb-75">
                                    <span class="fw-bolder me-25">Opening Date:</span>
                                    <span>{{ $specialLoanTaken->date??'' }}</span>
                                </li>
                                <li class="mb-75">
                                    <span class="fw-bolder me-25">Commencement:</span>
                                    <span >{{ $specialLoanTaken->commencement }}</span>
                                </li>
                                <li class="mb-75">
                                    <span class="fw-bolder me-25">Paid:</span>
                                    <span>{{ $specialLoanTaken->loan_amount - $specialLoanTaken->remain }}</span>
                                </li>

                                <li class="mb-75">
                                    <span class="fw-bolder me-25">Balance:</span>
                                    <span>{{ $specialLoanTaken->remain }}</span>
                                </li>


                                <li class="mb-75">
                                    <span class="fw-bolder me-25">Note:</span>
                                    <span class="badge bg-light-success">{{ $specialLoanTaken->note }}</span>
                                </li>
