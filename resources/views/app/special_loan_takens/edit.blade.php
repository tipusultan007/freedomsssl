        ...
        <div id="account-details">
          ...
          <div class="row mb-3">
            ...
            <div class="col-md-3 mb-2">
              ...
              <input type="number" class="form-control" id="interest1" step="any" name="interest1" value="{{ $specialLoanTaken->interest1 }}">
            </div>
            <div class="col-md-3 mb-2">
              <label for="interest2" class="form-label">স্পেশাল সুদের হার (%)</label>
              <input type="number" class="form-control" id="interest2" name="interest2" step="any" value="{{ $specialLoanTaken->interest2 }}">
            </div>
            <div class="col-md-3 mb-2">
