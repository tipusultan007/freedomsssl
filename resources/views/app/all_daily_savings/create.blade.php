                            ...
                            <form>
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6 mb-2">
                                        ...
                                        <input type="text" class="form-control" id="account_no" name="account_no" placeholder="Example: DS-100">
                                    </div>
                                    <div class="col-md-6 mb-2">
                                        <label for="account_no" class="form-label">Opening Data</label>
                                        <input type="text" class="form-control flatpickr-basic" id="opening_date" name="opening_date"  aria-label="MM/DD/YYYY">
                                    </div>
                            ...
                            <form>
                                <div class="row">
                                    ...
                                    <div class="mb-1 col-md-6">
                                        ...
                                        <input type="text" name="birthdate" id="birthdate" class="form-control flatpickr-basic"/>
                                    </div>
                                    <div class="mb-1 col-md-6">
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <button class="btn btn-primary btn-submit">
                                    <span class="align-middle d-sm-inline-block  d-none">
                                        <span class="spinner spinner-border spinner-border-sm d-none" style="display: none" role="status" aria-hidden="true"></span> Submit</span>
                                    <i data-feather="arrow-right" class="align-middle ms-sm-25 ms-0"></i>
                                </button>
                            </div>
                        </div>
