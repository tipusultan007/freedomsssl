                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-xl-3 col-md-6 col-12">
                                ...
                                @php
                                    $categories = \App\Models\CashinCategory::all();
                                @endphp
                                <select name="cashin_category_id" id="cashin_category_id"
...
@section('page-script')
    ...
    <script>
        ...
        $("#btn-filter").on('click', function () {
            ...
            let cat = $("#cashin_category_id").val();
