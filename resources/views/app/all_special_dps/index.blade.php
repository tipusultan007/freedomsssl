                                ...
                                <form>
                                    <div class="row mb-1">
                                        <div class="col-md-12 mb-1">
                                            ...
                                            <select class="select2-size-sm form-select dt-user-id" data-allow-clear="on" data-placeholder="-- Select User --" name="user_id" id="user_id">
                                                <option value=""></option>
                                        ...
                                        <div class="col-md-6  mb-0">
                                            ...
                                            <div class="input-group input-group-sm">
                                                ...
                                                <input type="number" class="form-control form-control-sm" name="account_no" id="account_no">
                                            </div>
                                            <span id="result" class="font-small-3"></span>
                                        </div>
                                        <div class="col-md-6 mb-0">
                                            @php
                                                $packages = \App\Models\SpecialDpsPackage::all();
                                            @endphp
                                        ...
                                        <div class="col-md-6 mb-0">
                                            <label class="form-label" for="account_no">Initial Amount</label>
                                            <input
                                                type="number"
                                                class="form-control form-control-sm dt-initial_amount"
                                                id="initial_amount"
                                        ...
                                        <div class="col-md-6 mb-0">
                                            ...
                                            <select name="introducer_id" id="introducer_id" class="select2-size-sm form-select">
                                ...
                                <form>
                                    <div class="row g-1">
                                        <div class="col-md-12 mb-0">
                                            ...
                                            <select class="select2-size-sm form-select dt-user-nominee-id" data-allow-clear="on" name="nominee_user_id" data-placeholder="-- Select User --" id="user_nominee_id">
                                                <option value=""></option>
                                                @forelse($users as $user)
                                                    <option value="{{ $user->id }}">{{ $user->name }}
                                                        || {{ $user->father_name }}</option>
                    ...
                    .on('click', function () {
                        ...
                        $.ajax({
                            ...
                            error: function () {
                                $this.attr('disabled', false).html($caption);
                                //$("#createAppModal").modal("hide");
                                toastr.error('New Special DPS account added failed.', 'Failed!', {
                                    closeButton: true,
                                    tapToDismiss: false
                                });
                                $(".datatables-basic").DataTable().destroy();
