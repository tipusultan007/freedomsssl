            ...
            <div class="col-xl-3 col-lg-4 col-md-4 order-1 order-md-0">
                        ...
                        <div class="user-avatar-section">
                            <div class="d-flex align-items-center flex-column">
                                <img
                                    ...
                                    src="{{ $takenLoan->user->profile_photo_url??'' }}"
                                    height="110"
                                    width="110"
                                    alt="User avatar"
                                />
                                <div class="user-info text-center">
                                    ...
                                    <span class="badge bg-light-secondary">{{ $takenLoan->user->phone1 }}</span>
                                </div>
                            </div>
                        </div>
              ...
              <span class="badge bg-light-primary p-75 rounded">
                <i data-feather="dollar-sign" class="font-medium-2"></i>
                                ...
                                <div class="ms-75">
                                    <h4 class="mb-0">{{ $takenLoan->remain }}</h4>
                                    <small>Loan</small>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="info-container">
                            <ul class="list-unstyled">
                                <li class="mb-75">
                                    ...
                                    <span>{{ $takenLoan->account_no??'' }}</span>
                                </li>
                                <li class="mb-75">
                                    <span class="fw-bolder me-25">Loan Amount:</span>
                                    <span>{{ $takenLoan->loan_amount??'' }}</span>
                                </li>
                                <li class="mb-75">
                                    <span class="fw-bolder me-25">Interest:</span>
                                    <span>{{ $takenLoan->interest1??'' }}% {{ $takenLoan->interest2>0?' | '.$takenLoan->interest2.'%':'' }}</span>
                                </li>
                                <li class="mb-75">
                                    <span class="fw-bolder me-25">Upto Amount:</span>
                                    <span>{{ $takenLoan->upto_amount??'N/A' }}</span>
                                </li>
                                <li class="mb-75">
                                    <span class="fw-bolder me-25">Opening Date:</span>
                                    <span>{{ $takenLoan->date??'' }}</span>
                                </li>
                                <li class="mb-75">
                                    <span class="fw-bolder me-25">Commencement:</span>
                                    <span >{{ $takenLoan->commencement }}</span>
                                </li>
                                <li class="mb-75">
                                    <span class="fw-bolder me-25">Paid:</span>
                                    <span>{{ $takenLoan->loan_amount - $takenLoan->remain }}</span>
                                </li>

                                <li class="mb-75">
                                    <span class="fw-bolder me-25">Balance:</span>
                                    <span>{{ $takenLoan->remain }}</span>
                                </li>


                                <li class="mb-75">
                                    <span class="fw-bolder me-25">Note:</span>
                                    <span class="badge bg-light-success">{{ $takenLoan->note }}</span>
                                </li>
                ...
                columnDefs:[
                    {
                        ...
                        render: function (data, type, full, meta) {
                            return (
                                ...
                                '<a href="javascript:;" data-id="'+full['paymentId']+'" class="dropdown-item delete-loan-payment">' +
                                feather.icons['trash'].toSvg({ class: 'font-small-4 me-50' }) +
                                'Delete Loan Payment</a>' +
                                '<a href="javascript:;" data-id="'+full['interestId']+'" class="dropdown-item delete-interest">' +
