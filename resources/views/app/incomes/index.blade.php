...
@section('content')
    ...
    <section class="container-fluid">
      <h3 class="fw-bolder text-success text-center">সকল আয়</h3>
      <hr>
        <div class="row">
            <div class="col-4">
                <div class="card">
                  <div class="card-header bg-primary py-0">
                    <h4 class="text-white mb-0 py-2">নতুন আয় এন্ট্রি</h4>
                  </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalCenterTitle">আয় সম্পাদনা</h5>
