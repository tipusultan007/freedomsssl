...
@section('content')
    <section class="app-user-view-account">
        <div class="row">
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 submission-form">
                <form id="collectionForm" method="POST" action="{{ route('dps-installments.store') }}">
                    @csrf
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 my-1">
                                            <div class="form-check form-check-inline">
                                                ...
                                                <label class="form-check-label" for="dps_installment">DPS
                                                    INSTALLMENT</label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-4 my-1">
                                            <div class="form-floating">
                                                <input type="number" class="form-control" name="advance_return"
                                                       id="advance_return"
                                                       placeholder="ADVANCE">
                                                <label class="font-small-2 fw-bold" for="advance_return">ADVANCE
                                                    RETURN</label>
                                            </div>
                                        </div>
                                        <div class="col-lg-4 my-1">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 my-1">
                                            <div class="form-check form-check-inline">
                                                ...
                                                <label class="form-check-label" for="loan_collection">LOAN
                                                    INSTALLMENT</label>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 my-1">
                                            <div class="form-floating">
                                                ...
                                                <label class="font-small-2 fw-bold" for="loan_installment">LOAN
                                                    PAYMENT</label>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 my-1">
                                        ...
                                        <div class="col-lg-6 my-1">
                                            <div class="form-floating">
                                                <input type="number" class="form-control" name="due_interest"
                                                       id="due_interest"
                                                       placeholder=" ">
                                                <label class="font-small-2 fw-bold" for="due_interest">DUE
                                                    INTEREST</label>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 my-1">
                                        ...
                                        <div class="col-lg-6 my-1">
                                            <div class="form-floating">
                                                <input type="number" class="form-control" name="loan_other_fee"
                                                       id="loan_other_fee"
                                                       placeholder="Other Fee">
                                                <label class="font-small-2 fw-bold" for="loan_other_fee">OTHER
                                                    FEE</label>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 my-1">
    ...
    <div class="modal fade" id="modalEditDpsInstallment" tabindex="-1" aria-labelledby="exampleModalCenterTitle"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalCenterTitle">Edit DPS Installment <span
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 my-1">
                                <div class="form-floating">
                                    ...
                                    <label class="font-small-2 fw-bold" for="edit_dps_installments">#
                                        INSTALLMENTS</label>
                                </div>
                            </div>
                            <div class="col-lg-4 my-1">
    ...
    <div class="modal fade" id="modalEditLoanInstallment" tabindex="-1" aria-labelledby="exampleModalCenterTitle"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalCenterTitle">Edit Loan Installment <span
                            class="text-success account_no"></span></h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                            aria-label="Close"></button>
                </div>
