    ...
    <section class="horizontal-wizard">
        <div class="row">
            ...
            <span class="bs-stepper-subtitle">Add Nominee Info</span>
                        ...
                        <div class="step" data-target="#deposit-info" role="tab" id="deposit-info-trigger">
                            <button type="button" class="step-trigger">
                                <span class="bs-stepper-box">2</span>
                                <span class="bs-stepper-label">
            <span class="bs-stepper-title">Deposit Info</span>
            <span class="bs-stepper-subtitle">Add Deposit Info</span>
          </span>
                            </button>
                        </div>
                        <div class="line">
                    ...
                    <div class="bs-stepper-content">
                        ...
                        <div id="deposit-info" class="content" role="tabpanel" aria-labelledby="deposit-info-trigger">
                            <div class="content-header">
                                <h5 class="mb-0">Deposit Info</h5>
                                <small>Enter FDR deposit Info.</small>
                            </div>
                            <form>
                                <div class="row">
                                    <div class="mb-1 col-md-6">
