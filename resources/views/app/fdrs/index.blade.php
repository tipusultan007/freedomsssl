        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body pb-3 px-sm-3">
                    <h1 class="text-center mb-1" id="createAppTitle">Add New FDR Account</h1>
                    <p class="text-center mb-2">Provide FDR Account data with this form</p>
                ...
                <span class="bs-stepper-box">
                  ...
                  <span class="bs-stepper-subtitle">FDR Deposit</span>
                </span>
                                </button>
                            </div>
                ...
                <span class="bs-stepper-box">
                  ...
                  <span class="bs-stepper-subtitle">Submit your app</span>
                        ...
                        <div class="bs-stepper-content shadow-none">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-12 mb-2">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-text" id="basic-addon3">FDR</span>
                                        ...
                                        <div class="col-md-5 mb-2 position-relative">
                                            <label for="account_no" class="form-label">Date</label>
                                            <input type="text" value="{{ date('Y-m-d') }}" placeholder="DD-MM-YYYY"
                                                   class="form-control flatpickr-basic" id="opening_date"
                                        ...
                                        <div class="col-md-7 mb-2">
                                            ...
                                            <select name="introducer_id" id="introducer_id" class="select2 form-select"
                                                    data-placeholder="-- Select Introducer --">
                                                <option value=""></option>
                            ...
                            >
                                <h5 class="mb-1">Enter FDR Deposit Details</h5>
                                <form>
                                    <div class="row">
                                        ...
                                        <div class="mb-1 col-md-6">
                                            <label class="form-label" for="address">Deposit Date</label>
                                            <input type="text" value="{{ date('Y-m-d') }}" placeholder="DD-MM-YYYY"
                                                   name="date" id="date" class="form-control flatpickr-basic"/>
                                        </div>
                                        <div class="mb-1 col-md-6">
...

                    {
                        ...
                        render: function (data, type, full, meta) {
                            return (
                                ...
                                'Details</a>' +
                                '<a href="javascript:;" class="dropdown-item deposit-list" data-id="' + full['id'] + '">' +
                                feather.icons['list'].toSvg({class: 'font-small-4 me-50'}) +
                                'Deposit List</a>' +
                    ...
                    .on('click', function () {
                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                                ...
                                toastr.success('New FDR account successfully added.', 'New FDR!', {
                                    closeButton: true,
                                    tapToDismiss: false
                                });
                            ...
                            error: function () {
                                $this.attr('disabled', false).html($caption);
                                $("#createFdrModal").modal("hide");
                                toastr.error('New FDR account added failed.', 'Failed!', {
                                    closeButton: true,
                                    tapToDismiss: false
                                });
                                $(".datatables-basic").DataTable().destroy();
